...
if __name__ == "__main__":
    ...
    parser.add_argument('--in_nwk', default='/home/azhukova/projects/bdeissct_dl/simulations_bdeissct/test/200_500/BD/tree.0.nwk', type=str, help="input tree")
    parser.add_argument('--out_nwk', default='/home/azhukova/projects/bdeissct_dl/simulations_bdeissct/test/200_500/BD/tree.0.chopped.nwk', type=str, help="output tree")
