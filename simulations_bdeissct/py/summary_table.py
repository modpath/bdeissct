...
if __name__ == "__main__":
    ...
    for real in params.real:
        ddf = pd.read_csv(real)[['R', 'd', 'rho', 'd_E', 'f_S', 'X_S', 'upsilon', 'X_C', 'n_tips', 'sf']]
        ddf['d'] *= ddf['sf']
        ddf['d_E'] *= ddf['sf']
    ...
    if params.estimates_bdct:
        for est in params.estimates_bdct:
            ...
            ['R', 'd', 'p', 'd_E', 'f_S', 'X_S', 'upsilon', 'X_C', 'type']] \
    ...
    if params.estimates_bdei:
        for est in params.estimates_bdei:
            ...
            df.loc[f'{i}.{est_label}',
            ['R', 'd', 'p', 'd_E', 'f_S', 'X_S', 'upsilon', 'X_C', 'type']] \
                = [la / psi, d, rho, d_E, 0, 1, 0, 1, est_label]
